...
function addItem(title,thumbnail,id){
    ...
    novoItem.innerHTML = `<div class='child float-left-child'>
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
                <a id="id_${id}" href="#" class="btn btn-primary d-grid gap-2 justify-content-md-end">
                ...
                <h5 class="card-title h5-spaces">${title}</h5>
            </div>
        </div>
    </div>  `
    mainArea.appendChild(novoItem)
}
